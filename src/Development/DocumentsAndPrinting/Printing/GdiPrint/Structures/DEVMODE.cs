...
using iTin.Core.Interop.Shared.Windows.Development.Graphics.Legacy.Gdi.Metafiles;
...
public struct DEVMODE : IEquatable<DEVMODE>
{
    ...
    /// </returns>
    public static bool operator ==(DEVMODE deviceInfo1, DEVMODE deviceInfo2) => deviceInfo1.Equals(deviceInfo2);
    ...
    /// 
    /// </summary>
    public static DEVMODE Empty = new() { dmSize = (short)Marshal.SizeOf(typeof(DEVMODE)) };
    #endregion
}
